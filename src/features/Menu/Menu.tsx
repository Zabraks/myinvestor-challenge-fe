...
export const Menu = () => {
  ...
  return (
    <div className="fixed flex items-center justify-center bottom-4 left-0 w-full z-50 md:min-w-40">
      <Card className="pt-4 md:min-w-40">
        <CardContent>
          <ItemGroup className="flex gap-2 flex-row justify-center">
            {ITEMS_MENU.map((item) => {
              ...
              return (
                <Item
                  ...
                  className="cursor-pointer p-3 hover:border-border"
                  key={item.title}
                >
                  <Icon className="w-4" />
